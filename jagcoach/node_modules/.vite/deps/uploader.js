...
function _(l4, t4, u4) {
  var i4, r3, o4, e3 = {};
  for (o4 in t4) "key" == o4 ? i4 = t4[o4] : "ref" == o4 ? r3 = t4[o4] : e3[o4] = t4[o4];
  if (arguments.length > 2 && (e3.children = arguments.length > 3 ? n.call(arguments, 2) : u4), "function" == typeof l4 && null != l4.defaultProps) for (o4 in l4.defaultProps) void 0 === e3[o4] && (e3[o4] = l4.defaultProps[o4]);
  return m(l4, e3, i4, r3, null);
}
function m(n3, u4, i4, r3, o4) {
  var e3 = { type: n3, props: u4, key: i4, ref: r3, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: null == o4 ? ++t : o4, __i: -1, __u: 0 };
...
function $() {
  for (var n3, t4, u4, r3, o4, f4, c4, s4 = 1; i.length; ) i.length > s4 && i.sort(e), n3 = i.shift(), s4 = i.length, n3.__d && (u4 = void 0, o4 = (r3 = (t4 = n3).__v).__e, f4 = [], c4 = [], t4.__P && ((u4 = w({}, r3)).__v = r3.__v + 1, l.vnode && l.vnode(u4), O(t4.__P, u4, r3, t4.__n, t4.__P.namespaceURI, 32 & r3.__u ? [o4] : null, f4, null == o4 ? S(r3) : o4, !!(32 & r3.__u), c4), u4.__v = r3.__v, u4.__.__k[u4.__i] = u4, z(f4, u4, c4), u4.__e != o4 && C(u4)));
  $.__r = 0;
}
function I(n3, l4, t4, u4, i4, r3, o4, e3, f4, c4, s4) {
  var a4, h3, y3, d3, w4, g4, _3 = u4 && u4.__k || v, m3 = l4.length;
  for (f4 = P(t4, l4, _3, f4, m3), a4 = 0; a4 < m3; a4++) null != (y3 = t4.__k[a4]) && (h3 = -1 === y3.__i ? p : _3[y3.__i] || p, y3.__i = a4, g4 = O(n3, y3, h3, i4, r3, o4, e3, f4, c4, s4), d3 = y3.__e, y3.ref && h3.ref != y3.ref && (h3.ref && q(h3.ref, null, y3), s4.push(y3.ref, y3.__c || d3, y3)), null == w4 && null != d3 && (w4 = d3), 4 & y3.__u || h3.__k === y3.__k ? f4 = A(y3, f4, n3) : "function" == typeof y3.type && void 0 !== g4 ? f4 = g4 : d3 && (f4 = d3.nextSibling), y3.__u &= -7);
  return t4.__e = w4, f4;
}
function P(n3, l4, t4, u4, i4) {
  var r3, o4, e3, f4, c4, s4 = t4.length, a4 = s4, h3 = 0;
  for (n3.__k = new Array(i4), r3 = 0; r3 < i4; r3++) null != (o4 = l4[r3]) && "boolean" != typeof o4 && "function" != typeof o4 ? (f4 = r3 + h3, (o4 = n3.__k[r3] = "string" == typeof o4 || "number" == typeof o4 || "bigint" == typeof o4 || o4.constructor == String ? m(null, o4, null, null, null) : d(o4) ? m(k, { children: o4 }, null, null, null) : void 0 === o4.constructor && o4.__b > 0 ? m(o4.type, o4.props, o4.key, o4.ref ? o4.ref : null, o4.__v) : o4).__ = n3, o4.__b = n3.__b + 1, e3 = null, -1 !== (c4 = o4.__i = L(o4, t4, f4, a4)) && (a4--, (e3 = t4[c4]) && (e3.__u |= 2)), null == e3 || null === e3.__v ? (-1 == c4 && (i4 > s4 ? h3-- : i4 < s4 && h3++), "function" != typeof o4.type && (o4.__u |= 4)) : c4 != f4 && (c4 == f4 - 1 ? h3-- : c4 == f4 + 1 ? h3++ : (c4 > f4 ? h3-- : h3++, o4.__u |= 4))) : n3.__k[r3] = null;
  if (a4) for (r3 = 0; r3 < s4; r3++) null != (e3 = t4[r3]) && 0 == (2 & e3.__u) && (e3.__e == u4 && (u4 = S(e3)), B(e3, e3));
  return u4;
}
function A(n3, l4, t4) {
  var u4, i4;
  if ("function" == typeof n3.type) {
    for (u4 = n3.__k, i4 = 0; u4 && i4 < u4.length; i4++) u4[i4] && (u4[i4].__ = n3, l4 = A(u4[i4], l4, t4));
    return l4;
  }
...
function L(n3, l4, t4, u4) {
  var i4, r3, o4 = n3.key, e3 = n3.type, f4 = l4[t4];
  if (null === f4 && null == n3.key || f4 && o4 == f4.key && e3 === f4.type && 0 == (2 & f4.__u)) return t4;
  if (u4 > (null != f4 && 0 == (2 & f4.__u) ? 1 : 0)) for (i4 = t4 - 1, r3 = t4 + 1; i4 >= 0 || r3 < l4.length; ) {
    if (i4 >= 0) {
...
function j(n3, l4, t4, u4, i4) {
  ...
  n: if ("style" == l4) if ("string" == typeof t4) n3.style.cssText = t4;
    ...
    if ("string" == typeof u4 && (n3.style.cssText = u4 = ""), u4) for (l4 in u4) t4 && l4 in t4 || T(n3.style, l4, "");
    if (t4) for (l4 in t4) u4 && t4[l4] === u4[l4] || T(n3.style, l4, t4[l4]);
  }
  else if ("o" == l4[0] && "n" == l4[1]) r3 = l4 != (l4 = l4.replace(f, "$1")), l4 = l4.toLowerCase() in n3 || "onFocusOut" == l4 || "onFocusIn" == l4 ? l4.toLowerCase().slice(2) : l4.slice(2), n3.l || (n3.l = {}), n3.l[l4 + r3] = t4, t4 ? u4 ? t4.t = u4.t : (t4.t = c, n3.addEventListener(l4, r3 ? a : s, r3)) : n3.removeEventListener(l4, r3 ? a : s, r3);
  else {
...
function O(n3, t4, u4, i4, r3, o4, e3, f4, c4, s4) {
  var a4, h3, p4, v3, y3, _3, m3, b3, S2, C4, M3, $3, P4, A4, H3, L3, T4, j4 = t4.type;
  ...
  n: if ("function" == typeof j4) try {
    if (b3 = t4.props, S2 = "prototype" in j4 && j4.prototype.render, C4 = (a4 = j4.contextType) && i4[a4.__c], M3 = a4 ? C4 ? C4.props.value : a4.__ : i4, u4.__c ? m3 = (h3 = t4.__c = u4.__c).__ = h3.__E : (S2 ? t4.__c = h3 = new j4(b3, M3) : (t4.__c = h3 = new x(b3, M3), h3.constructor = j4, h3.render = D), C4 && C4.sub(h3), h3.props = b3, h3.state || (h3.state = {}), h3.context = M3, h3.__n = i4, p4 = h3.__d = true, h3.__h = [], h3._sb = []), S2 && null == h3.__s && (h3.__s = h3.state), S2 && null != j4.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = w({}, h3.__s)), w(h3.__s, j4.getDerivedStateFromProps(b3, h3.__s))), v3 = h3.props, y3 = h3.state, h3.__v = t4, p4) S2 && null == j4.getDerivedStateFromProps && null != h3.componentWillMount && h3.componentWillMount(), S2 && null != h3.componentDidMount && h3.__h.push(h3.componentDidMount);
    else {
      if (S2 && null == j4.getDerivedStateFromProps && b3 !== v3 && null != h3.componentWillReceiveProps && h3.componentWillReceiveProps(b3, M3), !h3.__e && (null != h3.shouldComponentUpdate && false === h3.shouldComponentUpdate(b3, h3.__s, M3) || t4.__v == u4.__v)) {
        for (t4.__v != u4.__v && (h3.props = b3, h3.state = h3.__s, h3.__d = false), t4.__e = u4.__e, t4.__k = u4.__k, t4.__k.some(function(n4) {
          n4 && (n4.__ = t4);
    ...
    if (h3.context = M3, h3.props = b3, h3.__P = n3, h3.__e = false, P4 = l.__r, A4 = 0, S2) {
      for (h3.state = h3.__s, h3.__d = false, P4 && P4(t4), a4 = h3.render(h3.props, h3.state, h3.context), H3 = 0; H3 < h3._sb.length; H3++) h3.__h.push(h3._sb[H3]);
      h3._sb = [];
    } else do {
      h3.__d = false, P4 && P4(t4), a4 = h3.render(h3.props, h3.state, h3.context), h3.state = h3.__s;
    } while (h3.__d && ++A4 < 25);
    h3.state = h3.__s, null != h3.getChildContext && (i4 = w(w({}, i4), h3.getChildContext())), S2 && !p4 && null != h3.getSnapshotBeforeUpdate && (_3 = h3.getSnapshotBeforeUpdate(v3, y3)), L3 = a4, null != a4 && a4.type === k && null == a4.key && (L3 = N(a4.props.children)), f4 = I(n3, d(L3) ? L3 : [L3], t4, u4, i4, r3, o4, e3, f4, c4, s4), h3.base = t4.__e, t4.__u &= -161, h3.__h.length && e3.push(h3), m3 && (h3.__E = h3.__ = null);
  } catch (n4) {
  ...
  else null == o4 && t4.__v == u4.__v ? (t4.__k = u4.__k, t4.__e = u4.__e) : f4 = t4.__e = V(u4.__e, t4, u4, i4, r3, o4, e3, c4, s4);
...
function V(t4, u4, i4, r3, o4, e3, f4, c4, s4) {
  var a4, h3, v3, y3, w4, _3, m3, b3 = i4.props, k4 = u4.props, x4 = u4.type;
  ...
  if (null == t4) {
    ...
    t4 = document.createElementNS(o4, x4, k4.is && k4), c4 && (l.__m && l.__m(u4, e3), c4 = false), e3 = null;
  }
  if (null === x4) b3 === k4 || c4 && t4.data === k4 || (t4.data = k4);
  else {
    if (e3 = e3 && n.call(t4.childNodes), b3 = i4.props || p, !c4 && null != e3) for (b3 = {}, a4 = 0; a4 < t4.attributes.length; a4++) b3[(w4 = t4.attributes[a4]).name] = w4.value;
    ...
    for (a4 in k4) w4 = k4[a4], "children" == a4 ? y3 = w4 : "dangerouslySetInnerHTML" == a4 ? h3 = w4 : "value" == a4 ? _3 = w4 : "checked" == a4 ? m3 = w4 : c4 && "function" != typeof w4 || b3[a4] === w4 || j(t4, a4, w4, b3[a4], o4);
    if (h3) c4 || v3 && (h3.__html === v3.__html || h3.__html === t4.innerHTML) || (t4.innerHTML = h3.__html), u4.__k = [];
    else if (v3 && (t4.innerHTML = ""), I("template" === u4.type ? t4.content : t4, d(y3) ? y3 : [y3], u4, i4, r3, "foreignObject" == x4 ? "http://www.w3.org/1999/xhtml" : o4, e3, f4, e3 ? e3[0] : i4.__k && S(i4, 0), c4, s4), null != e3) for (a4 = e3.length; a4--; ) g(e3[a4]);
    c4 || (a4 = "value", "progress" == x4 && null == _3 ? t4.removeAttribute("value") : void 0 !== _3 && (_3 !== t4[a4] || "progress" == x4 && !_3 || "option" == x4 && _3 !== b3[a4]) && j(t4, a4, _3, b3[a4], o4), a4 = "checked", void 0 !== m3 && m3 !== t4[a4] && j(t4, a4, m3, b3[a4], o4));
  }
  return t4;
}
function q(n3, t4, u4) {
...
function B(n3, t4, u4) {
  ...
  if (i4 = n3.__k) for (r3 = 0; r3 < i4.length; r3++) i4[r3] && B(i4[r3], t4, u4 || "function" != typeof n3.type);
...
function E(t4, u4, i4) {
  var r3, o4, e3, f4;
  u4 == document && (u4 = document.documentElement), l.__ && l.__(t4, u4), o4 = (r3 = "function" == typeof i4) ? null : i4 && i4.__k || u4.__k, e3 = [], f4 = [], O(u4, t4 = (!r3 && i4 || u4).__k = _(k, null, [t4]), o4 || p, p, u4.namespaceURI, !r3 && i4 ? [i4] : o4 ? null : u4.firstChild ? n.call(u4.childNodes) : null, e3, !r3 && i4 ? i4 : o4 ? o4.__e : u4.firstChild, r3, f4), z(e3, t4, f4);
}
function G(n3, l4) {
  E(n3, l4, G);
}
function J(l4, t4, u4) {
  ...
  for (o4 in l4.type && l4.type.defaultProps && (e3 = l4.type.defaultProps), t4) "key" == o4 ? i4 = t4[o4] : "ref" == o4 ? r3 = t4[o4] : f4[o4] = void 0 === t4[o4] && void 0 !== e3 ? e3[o4] : t4[o4];
  return arguments.length > 2 && (f4.children = arguments.length > 3 ? n.call(arguments, 2) : u4), m(l4.type, f4, i4 || l4.key, r3 || l4.ref, null);
}
function K(n3) {
  function l4(n4) {
    var t4, u4;
    return this.getChildContext || (t4 = /* @__PURE__ */ new Set(), (u4 = {})[l4.__c] = this, this.getChildContext = function() {
      return u4;
  ...
  "node_modules/preact/dist/preact.module.js"() {
    ...
    n = v.slice, l = { __e: function(n3, l4, t4, u4) {
      for (var i4, r3, o4; l4 = l4.__; ) if ((i4 = l4.__c) && !i4.__) try {
        if ((r3 = i4.constructor) && null != r3.getDerivedStateFromError && (i4.setState(r3.getDerivedStateFromError(n3)), o4 = i4.__d), null != i4.componentDidCatch && (i4.componentDidCatch(n3, u4 || {}), o4 = i4.__d), o4) return i4.__E = i4;
      } catch (l5) {
        n3 = l5;
      }
      throw n3;
      ...
      var __webpack_modules__ = {
        ...
        "./src/index.ts": (
          ...
          function(__unused_webpack_module, __webpack_exports__, __webpack_require__2) {
            ...
            function UploadsService_async(f4) {
              return function() {
                for (var args = [], i4 = 0; i4 < arguments.length; i4++) {
                  args[i4] = arguments[i4];
                }
          ...
          function(__unused_webpack_module, __webpack_exports__, __webpack_require__2) {
            ...
            function ProgressSmoother(config) {
              ...
              function calculateEMA(value, now, lastTime) {
                var a4 = alpha(now, lastTime);
                return a4 * value + (1 - a4) * movingAverage;
              }
                        ...
                        return _invokeIgnored(function() {
                          if (nextPart !== void 0) {
                            ...
                            var progress = function progress2(_ref) {
                              ...
                              var totalBytesSent = bytesSentByEachWorker.reduce(function(a4, b3) {
                                return a4 + b3;
                              });
...
function y2(n3, u4) {
  var i4 = p3(t3++, 3);
  !c3.__s && C2(i4.__H, u4) && (i4.__ = n3, i4.u = u4, r2.__H.__h.push(i4));
}
function _2(n3, u4) {
  var i4 = p3(t3++, 4);
...
function x2(n3) {
  var u4 = r2.context[n3.__c], i4 = p3(t3++, 9);
...
function _n(n3) {
  return pn(n3) ? J.apply(null, arguments) : n3;
}
function bn(n3) {
  return !!n3.__k && (E(null, n3), true);
}
function Sn(n3) {
  return n3 && (n3.base || 1 === n3.nodeType && n3) || null;
}
var I2, T3, A3, L2, O2, F3, U, H2, q3, G2, J2, K2, Q, X, en, cn, ln, fn, an, sn, hn, vn, gn, En, Cn, xn, Rn;
var init_compat_module = __esm({
  "node_modules/preact/compat/dist/compat.module.js"() {
    ...
    O2 = { map: L2, forEach: L2, count: function(n3) {
      ...
      "string" == typeof n3.type && function(n4) {
        ...
        for (var i4 in t4) {
          ...
          if (!("value" === i4 && "defaultValue" in t4 && null == c4 || Q && "children" === i4 && "noscript" === e3 || "class" === i4 || "className" === i4)) {
            ...
            "defaultValue" === i4 && "value" in t4 && null == t4.value ? i4 = "value" : "download" === i4 && true === c4 ? c4 = "" : "translate" === l4 && "no" === c4 ? c4 = false : "o" === l4[0] && "n" === l4[1] ? "ondoubleclick" === l4 ? i4 = "ondblclick" : "onchange" !== l4 || "input" !== e3 && "textarea" !== e3 || X(t4.type) ? "onfocus" === l4 ? i4 = "onfocusin" : "onblur" === l4 ? i4 = "onfocusout" : J2.test(i4) && (i4 = l4) : l4 = i4 = "oninput" : o4 && G2.test(i4) ? i4 = i4.replace(K2, "-$&").toLowerCase() : null === c4 && (c4 = void 0), "oninput" === l4 && u4[i4 = l4] && (i4 = "oninputCapture"), u4[i4] = c4;
          }
        }
    ...
    hn = { ReactCurrentDispatcher: { current: { readContext: function(n3) {
    ...
    Cn = k;
    xn = pn;
    Rn = { useState: d2, useId: g2, useReducer: h2, useEffect: y2, useLayoutEffect: _2, useInsertionEffect: I2, useTransition: k3, useDeferredValue: w3, useSyncExternalStore: C3, startTransition: R, useRef: A2, useImperativeHandle: F2, useMemo: T2, useCallback: q2, useContext: x2, useDebugValue: P2, version: "18.3.1", Children: O2, render: nn, hydrate: tn, unmountComponentAtNode: bn, createPortal: $2, createElement: _, createContext: K, createFactory: dn, cloneElement: _n, createRef: b, Fragment: k, isValidElement: pn, isElement: xn, isFragment: mn, isMemo: yn, findDOMNode: Sn, Component: x, PureComponent: N2, memo: M2, forwardRef: D3, flushSync: En, unstable_batchedUpdates: gn, StrictMode: Cn, Suspense: P3, SuspenseList: B3, lazy: z3, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: hn };
  }
});
  ...
  "node_modules/uploader/dist/main.js"(exports, module) {
    (function() {
      ...
      !function() {
        ...
        function hsv2rgb(h3, s4, v3) {
          var f4 = function f5(n3) {
            var k4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : (n3 + h3 / 60) % 6;
            return v3 - v3 * s4 * Math.max(Math.min(k4, 4 - k4, 1), 0);
          };
          return [f4(5), f4(3), f4(1)];
        }
        function hexToRgb(hex) {
          var shorthandRegex = /^#?([a-f\d])([a-f\d])([a-f\d])$/i;
          hex = hex.replace(shorthandRegex, function(_3, r3, g4, b3) {
        ...
        function highlightColor(hex, amount) {
          ...
          var _rgb2hsv = rgb2hsv(r3, g4, b3), _rgb2hsv2 = _slicedToArray(_rgb2hsv, 3), h3 = _rgb2hsv2[0], s4 = _rgb2hsv2[1], v3 = _rgb2hsv2[2];
          var clipToFactor = function clipToFactor2(x4) {
            return Math.min(1, Math.max(0, x4));
          };
          var _hsv2rgb$map = hsv2rgb(h3, clipToFactor(s4 + amount * -1), clipToFactor(v3 / 255 + amount) * 255).map(Math.round), _hsv2rgb$map2 = _slicedToArray(_hsv2rgb$map, 3), rNew = _hsv2rgb$map2[0], gNew = _hsv2rgb$map2[1], bNew = _hsv2rgb$map2[2];
        ...
        var __rest = function(s4, e3) {
          var t4 = {};
          for (var p4 in s4) {
            if (Object.prototype.hasOwnProperty.call(s4, p4) && e3.indexOf(p4) < 0) t4[p4] = s4[p4];
          }
          if (s4 != null && typeof Object.getOwnPropertySymbols === "function") for (var i4 = 0, p4 = Object.getOwnPropertySymbols(s4); i4 < p4.length; i4++) {
            if (e3.indexOf(p4[i4]) < 0 && Object.prototype.propertyIsEnumerable.call(s4, p4[i4])) t4[p4[i4]] = s4[p4[i4]];
          }
          return t4;
        };
        ...
        function Modal_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return Modal_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return Modal_arrayLikeToArray(o4, minLen);
        }
        ...
        function UseDimensionsFromElement_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return UseDimensionsFromElement_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return UseDimensionsFromElement_arrayLikeToArray(o4, minLen);
        }
        ...
        ;
        function WidgetBase_slicedToArray(arr, i4) {
          return WidgetBase_arrayWithHoles(arr) || WidgetBase_iterableToArrayLimit(arr, i4) || WidgetBase_unsupportedIterableToArray(arr, i4) || WidgetBase_nonIterableRest();
        }
        ...
        function WidgetBase_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return WidgetBase_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return WidgetBase_arrayLikeToArray(o4, minLen);
        }
        ...
        function WidgetBase_iterableToArrayLimit(arr, i4) {
          var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"];
          if (_i == null) return;
          var _arr = [];
          var _n2 = true;
        ...
        function UploadButton_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return UploadButton_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return UploadButton_arrayLikeToArray(o4, minLen);
        }
        ...
        function ProgressIcon_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return ProgressIcon_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return ProgressIcon_arrayLikeToArray(o4, minLen);
        }
        ...
        function SubmittedFileComponent_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return SubmittedFileComponent_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return SubmittedFileComponent_arrayLikeToArray(o4, minLen);
        }
        ...
        function UseDragDrop_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return UseDragDrop_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return UseDragDrop_arrayLikeToArray(o4, minLen);
        }
        ...
        function Draggable_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return Draggable_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return Draggable_arrayLikeToArray(o4, minLen);
        }
        ...
        function ResizableSquare_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return ResizableSquare_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return ResizableSquare_arrayLikeToArray(o4, minLen);
        }
        ...
        function Spinner_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return Spinner_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return Spinner_arrayLikeToArray(o4, minLen);
        }
        ...
        function ImageEditorLayout_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return ImageEditorLayout_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return ImageEditorLayout_arrayLikeToArray(o4, minLen);
        }
        ...
        function FormUtils_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return FormUtils_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return FormUtils_arrayLikeToArray(o4, minLen);
        }
        ...
        function SubmitButton_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return SubmitButton_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return SubmitButton_arrayLikeToArray(o4, minLen);
        }
        ...
        function ImageCropper_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return ImageCropper_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return ImageCropper_arrayLikeToArray(o4, minLen);
        }
        ...
        function UseImageList_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return UseImageList_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return UseImageList_arrayLikeToArray(o4, minLen);
        }
        ...
        function UseShowImageEditor_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return UseShowImageEditor_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return UseShowImageEditor_arrayLikeToArray(o4, minLen);
        }
        ...
        function UploadWidget_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return UploadWidget_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return UploadWidget_arrayLikeToArray(o4, minLen);
        }
        ...
        var UploadWidget_rest = function(s4, e3) {
          var t4 = {};
          for (var p4 in s4) {
            if (Object.prototype.hasOwnProperty.call(s4, p4) && e3.indexOf(p4) < 0) t4[p4] = s4[p4];
          }
        ...
        function ModalContainer_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return ModalContainer_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return ModalContainer_arrayLikeToArray(o4, minLen);
        }
        ...
        function RootContainer_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return RootContainer_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return RootContainer_arrayLikeToArray(o4, minLen);
        }
        ...
        function UploadManager_unsupportedIterableToArray(o4, minLen) {
          if (!o4) return;
          if (typeof o4 === "string") return UploadManager_arrayLikeToArray(o4, minLen);
          var n3 = Object.prototype.toString.call(o4).slice(8, -1);
          if (n3 === "Object" && o4.constructor) n3 = o4.constructor.name;
          if (n3 === "Map" || n3 === "Set") return Array.from(o4);
          if (n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return UploadManager_arrayLikeToArray(o4, minLen);
        }
